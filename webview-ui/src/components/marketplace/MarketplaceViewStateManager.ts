 ...
 *
 * This class manages the state for the marketplace view in the Syntx extensions interface.
 *
 * IMPORTANT: Fixed issue where the marketplace feature was causing the Syntx extensions interface
