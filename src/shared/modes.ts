...
export const modes: readonly ModeConfig[] = [
	...
	},
	{
		...
		name: "💻 Code",
		roleDefinition:
			"You are SyntX, a highly skilled software engineer with extensive knowledge in many programming languages, frameworks, design patterns, and best practices.",
		whenToUse:
	...
	},
	{
		...
		name: "🪲 Debug",
		roleDefinition:
			"You are SyntX, an expert software debugger specializing in systematic problem diagnosis and resolution.",
		whenToUse:
