...
<div align="center">
  ...
  <a href="https://discord.gg/FzndMpbhDd" target="_blank"><img src="https://img.shields.io/badge/Dołącz%20do%20Discord-5865F2?style=for-the-badge&logo=discord&logoColor=white" alt="Dołącz do Discord"></a>
...
<a href="https://marketplace.visualstudio.com/items?itemName=OrangecatTechPvtLtd.syntx" target="_blank"><img src="https://img.shields.io/badge/Pobierz%20z%20VS%20Marketplace-blue?style=for-the-badge&logo=visualstudiocode&logoColor=white" alt="Pobierz z VS Marketplace"></a>
<a href="https://github.com/OrangeCat-Technologies/SyntX/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop" target="_blank"><img src="https://img.shields.io/badge/Prośby%20o%20funkcje-yellow?style=for-the-badge" alt="Prośby o funkcje"></a>
<a href="https://marketplace.visualstudio.com/items?itemName=OrangecatTechPvtLtd.syntx&ssr=false#review-details" target="_blank"><img src="https://img.shields.io/badge/Oceń%20%26%20Zrecenzuj-green?style=for-the-badge" alt="Oceń & Zrecenzuj"></a>
...
**Syntx** to napędzany przez AI **autonomiczny agent kodujący**, który funkcjonuje w Twoim edytorze. Potrafi:
...
Niezależnie od tego, czy szukasz elastycznego partnera do kodowania, architekta systemu, czy wyspecjalizowanych ról, takich jak inżynier QA lub menedżer produktu, Syntx może pomóc Ci budować oprogramowanie efektywniej.
...
1. [Zainstaluj Syntx](https://docs.roocode.com/getting-started/installing)
...
Syntx jest wyposażony w potężne [narzędzia](https://docs.roocode.com/basic-usage/how-tools-work), które mogą:
...
MCP rozszerza możliwości Syntx, umożliwiając dodawanie nieograniczonej liczby niestandardowych narzędzi. Integruj się z zewnętrznymi API, łącz z bazami danych lub twórz wyspecjalizowane narzędzia deweloperskie - MCP zapewnia framework, aby rozszerzyć funkcjonalność Syntx w celu spełnienia Twoich specyficznych potrzeb.

### Personalizacja

Spraw, aby Syntx działał po Twojemu za pomocą:
...
- **Discord:** [Dołącz do naszego serwera Discord](https://discord.gg/FzndMpbhDd), aby uzyskać pomoc w czasie rzeczywistym i dyskusje
- **GitHub:** [Zgłaszaj problemy](https://github.com/OrangeCat-Technologies/SyntX/issues) lub [proś o funkcje](https://github.com/OrangeCat-Technologies/SyntX/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop)
...
4. **Debugowanie**:
   Naciśnij `F5` (lub **Uruchom** → **Rozpocznij debugowanie**) w VSCode, aby otworzyć nową sesję z załadowanym Syntx.
...
Dziękujemy wszystkim naszym współtwórcom, którzy pomogli ulepszyć Syntx!
...
**Ciesz się Syntx!** Niezależnie od tego, czy trzymasz go na krótkiej smyczy, czy pozwalasz mu swobodnie działać autonomicznie, nie możemy się doczekać, aby zobaczyć, co zbudujesz. Jeśli masz pytania lub pomysły na funkcje, wpadnij na naszą [Discord](https://discord.gg/FzndMpbhDd). Szczęśliwego kodowania!
