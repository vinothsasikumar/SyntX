...
<div align="center">
  ...
  <a href="https://discord.gg/FzndMpbhDd" target="_blank"><img src="https://img.shields.io/badge/Entrar%20no%20Discord-5865F2?style=for-the-badge&logo=discord&logoColor=white" alt="Entrar no Discord"></a>
...
<a href="https://marketplace.visualstudio.com/items?itemName=OrangecatTechPvtLtd.syntx" target="_blank"><img src="https://img.shields.io/badge/Baixar%20no%20VS%20Marketplace-blue?style=for-the-badge&logo=visualstudiocode&logoColor=white" alt="Baixar no VS Marketplace"></a>
<a href="https://github.com/OrangeCat-Technologies/SyntX/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop" target="_blank"><img src="https://img.shields.io/badge/Solicitar%20Recursos-yellow?style=for-the-badge" alt="Solicitar Recursos"></a>
<a href="https://marketplace.visualstudio.com/items?itemName=OrangecatTechPvtLtd.syntx&ssr=false#review-details" target="_blank"><img src="https://img.shields.io/badge/Avaliar%20%26%20Comentar-green?style=for-the-badge" alt="Avaliar & Comentar"></a>
...
**Syntx** é um **agente de codificação autônomo** movido a IA que reside no seu editor. Ele pode:
...
Seja você esteja buscando um parceiro de codificação flexível, um arquiteto de sistema ou funções especializadas como engenheiro de QA ou gerente de produto, o Syntx pode ajudá-lo a construir software com mais eficiência.
...
1. [Instale o Syntx](https://docs.roocode.com/getting-started/installing)
...
O Syntx vem com poderosas [ferramentas](https://docs.roocode.com/basic-usage/how-tools-work) que podem:
...
O MCP amplia as capacidades do Syntx permitindo que você adicione ferramentas personalizadas ilimitadas. Integre com APIs externas, conecte-se a bancos de dados ou crie ferramentas de desenvolvimento especializadas - o MCP fornece o framework para expandir a funcionalidade do Syntx para atender às suas necessidades específicas.

### Personalização

Faça o Syntx funcionar do seu jeito com:
...
- **Discord:** [Participe do nosso servidor Discord](https://discord.gg/FzndMpbhDd) para ajuda em tempo real e discussões
- **GitHub:** [Reportar problemas](https://github.com/OrangeCat-Technologies/SyntX/issues) ou [solicitar recursos](https://github.com/OrangeCat-Technologies/SyntX/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop)
...
4. **Depuração**:
   Pressione `F5` (ou **Executar** → **Iniciar Depuração**) no VSCode para abrir uma nova sessão com o Syntx carregado.
...
Obrigado a todos os nossos contribuidores que ajudaram a tornar o Syntx melhor!
...
**Aproveite o Syntx!** Seja você o mantenha em uma coleira curta ou deixe-o vagar autonomamente, mal podemos esperar para ver o que você construirá. Se você tiver dúvidas ou ideias de recursos, passe por nossa [Discord](https://discord.gg/FzndMpbhDd). Feliz codificação!
